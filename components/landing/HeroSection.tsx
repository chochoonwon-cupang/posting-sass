...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/80 bg-gradient-to-br from-indigo-500/10 via-violet-50/60 to-white p-8 shadow-lg md:p-12">
      <div className="relative z-10">
        ...
        <p className="mt-2 text-sm text-zinc-600">
          최소 70원부터 — 상위 입찰 완료 후 하위 입찰이 순차 처리
        </p>
